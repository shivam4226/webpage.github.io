<html>  
  ...
  <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
   ...
   <h3 align-item="center">How to Implement Google reCaptcha in PHP Form</a></h3><br />
   <br />
   <div class="panel panel-default">
    ...
    <div class="panel-body">
     ...
     <form metod="post" id="captcha_form">
      ...
      <div class="form-group">
      <div class="g-recaptcha" data-sitekey="6LeaD7YcAAAAABTPA0icnSD0CsbLdmczZQZpfh9D"></div>
